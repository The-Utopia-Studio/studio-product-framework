...
- [docs/tooling.md](./docs/tooling.md) — Rams, Greptile/greploop, PostHog, Sentry
...
- Use Rams for design review, Greptile + greploop for code review, and PostHog + Sentry for observability.
